...
The APPL-0.95-PGVI version is a C++ implementation of the PGVI algorithm [1], using the factored MOMDP representation [2]. It takes as input a POMDP model in the POMDP or POMDPX file format and produces a policy file. It also contains a simple simulator for evaluating the quality of the computed policy. More information can be found at http://motion.comp.nus.edu.sg/projects/pomdp/pomdp.html.

For bug reports and suggestions, please email <zzzhang@suda.edu.cn>.

[1] Z. Zhang, D. Hsu and W. S. Lee, Covering Number for Efficient Heuristic-Based POMDP Planning, In Proceedings of the 31st International Conference on Machine Learning (ICML), pages 28--36, 2014. 
...
========================================================================
5-May-2013
* Modified the SARSOP algorithm into the PGVI algorithm based on version 0.95.

6-Mar-2012
* Added support for intra-slice dependency between variables in POMDPX model. Only edges from fully observable state X to partially observable state Y are allowed.
...
* The main POMDP solver now uses the PGVI algorithm with the MOMDP representation. 
