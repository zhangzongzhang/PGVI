...
AlphaPlane::AlphaPlane(void) : alpha (new alpha_vector())
{
	...
	solverData = new PGVIAlphaPlaneTuple();
}
SharedPointer<AlphaPlane> AlphaPlane::duplicate()
{
	...
	result->solverData = new PGVIAlphaPlaneTuple();
	return result;
}
...
void AlphaPlane::init(int _timeStamp, BeliefTreeNode* _birthBelief)
{
	...
	PGVIAlphaPlaneTuple *attachedData = (PGVIAlphaPlaneTuple *)this->solverData;
...
{
	PGVIAlphaPlaneTuple *planeTuple = (PGVIAlphaPlaneTuple *)(this->solverData);
